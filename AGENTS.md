<INSTRUCTIONS>
Below is a **production-grade `AGENTS.md`**, written to be **dropped directly into a repository**, and explicitly aligned with **IDesign / Juval Löwy’s Method** and the way alumni consistently frame engineering discipline.

This file assumes:

* **Agents are AI processes**
* Agents may write code, design, review, estimate, or analyze
* The file acts as a **hard behavioral contract**, not a suggestion

I am intentionally **strict** here — a permissive `AGENTS.md` is worse than none.

---

```md
# AGENTS.md
IDesign Method – AI Agent Operating Rules
```
